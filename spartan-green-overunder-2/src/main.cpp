...
pros::Motor frontRight(FRONT_RIGHT_PORT, MOTOR_GEAR_BLUE);
pros::Motor middleRight(MIDDLE_RIGHT_PORT, MOTOR_GEAR_BLUE);
pros::Motor backRight(BACK_RIGHT_PORT, MOTOR_GEAR_BLUE);
pros::Motor frontLeft(FRONT_LEFT_PORT, MOTOR_GEAR_BLUE, true);
pros::Motor middleLeft(MIDDLE_LEFT_PORT, MOTOR_GEAR_BLUE, true);
pros::Motor backLeft(BACK_LEFT_PORT, MOTOR_GEAR_BLUE, true);
pros::Motor cataRight(CATA_RIGHT_PORT, MOTOR_GEAR_GREEN, true);
pros::Motor cataLeft(CATA_LEFT_PORT, MOTOR_GEAR_GREEN);
pros::Motor intake(INTAKE_PORT, MOTOR_GEAR_GREEN, true);
...
void opcontrol() {
	...
	while (true) {
		...
		if (con.get_digital(DIGITAL_R1)) {
			cataLeft.move_velocity(200); // 60% of 200 rpm
			cataRight.move_velocity(200);
		} else if (con.get_digital(DIGITAL_R2)) {
			cataLeft.move_velocity(-200); // 60% of 200 rpm
			cataRight.move_velocity(-200);
		} else {
			cataLeft.move_velocity(0); // 60% of 200 rpm
			cataRight.move_velocity(0);
		}
